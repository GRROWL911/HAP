...
public extension ServiceType {
   ...
   static let leakSensor = ServiceType(0x83)
   ...
   static let fanv2 = ServiceType(0xB7)
   static let garageDoorOpener = ServiceType(0x41)
   static let lockManagement = ServiceType(0x44)
   static let lockMechanism = ServiceType(0x45)
   static let securitySystem = ServiceType(0x7E)
   static let carbonMonoxideSensor = ServiceType(0x7F)
   static let carbonDioxideSensor = ServiceType(0x97)
   static let cameraRTPStreamManagement = ServiceType(0x110)
   static let microphone = ServiceType(0x112)
   static let speaker = ServiceType(0x113)
   static let doorbell = ServiceType(0x121)
   static let slat = ServiceType(0xB9)
   static let filterMaintenance = ServiceType(0xBA)
   static let airPurifier = ServiceType(0xBB)
   static let serviceLabel = ServiceType(0xCC)
}
